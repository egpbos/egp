...
filename_cubep3m = '/net/dataserver1/data/users/pbos/cubep3m/test1.15_read_seed/output/0.000xv0.dat'
...
mlab.figure(1, size=(1000,1000))
mlab.points3d(gadget.pos[:,0], gadget.pos[:,1], gadget.pos[:,2], mode='point', opacity=0.5)

mlab.figure(2, size=(1000,1000))
mlab.points3d(cubep3m.pos[:,0], cubep3m.pos[:,1], cubep3m.pos[:,2], mode='point', opacity=0.5)
#mlab.savefig('/Users/users/pbos/code/egp/testing/compare_cubep3m_gadget_runs_cubep3m_move_back_grid.png')

#mlab.figure(3, size=(1000,1000))
