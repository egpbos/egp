...
MyDouble analyse_phase_space(MyIDType, MyDouble *, MyDouble *, MyDouble *, MyDouble *, MyDouble *, MyDouble *, MyDouble *, MyDouble *);
#endif
void get_current_ps_info(MyIDType, MyDouble *, MyDouble *);
/* some math functions we need from phasespace_math.c */
void ludcmp(MyDouble **, int , int *, MyDouble *);
MyDouble **matrix(long, long, long, long);
MyDouble *vector(long , long );
void free_matrix(MyDouble **, long, long, long, long);
void free_vector(MyDouble *, long, long);
void mult_matrix(MyDouble **, MyDouble **, int, MyDouble **); 
void mult_matrix_transpose_A(MyDouble **, MyDouble **, int, MyDouble **);
void svdcmp(MyDouble **, int, int, MyDouble *, MyDouble **); 
void luinvert(MyDouble **, int, MyDouble **); 
void eigsrt(MyDouble *, MyDouble **, int n);
void jacobi(MyDouble **, int n, MyDouble *, MyDouble **, int *);
#endif
...
extern void eos_calc_dsdt( double temp, double rho, double *xnuc, double e, double s, double dedt, double time, double *dsdt );
extern void eos_calc_egiven( double rho, double *xnuc, double e, double *temp, double *s );
extern void eos_calc_sgiven( double rho, double *xnuc, double s, double *temp, double *p, double *e );
extern void eos_calc_egiven2( double rho, double *xnuc, double e, double *temp, double *p );
#endif
#ifdef HEALPIX
