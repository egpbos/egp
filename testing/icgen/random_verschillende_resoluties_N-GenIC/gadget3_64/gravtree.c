...
#if (!defined(SIM_ADAPTIVE_SOFT) && !defined(COMOVING_ADAPTIVE_SOFT))
...
#ifdef COMOVING_ADAPTIVE_SOFT
 if (ThisTask == 0)
  {
   printf("COMOVING/TREE adaptive softening: current scale factor = %g\n", pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT));
   fflush(stdout);
  }

  /* set the table values, because it is used for the time stepping, the Plummer equivalent softening length */
  All.SofteningTable[0] = All.SofteningGas * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);
  All.SofteningTable[1] = All.SofteningHalo * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);  
  All.SofteningTable[2] = All.SofteningDisk * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);    
  All.SofteningTable[3] = All.SofteningBulge * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);      
  All.SofteningTable[4] = All.SofteningStars * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);        
  All.SofteningTable[5] = All.SofteningBndry * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);          
...
/*1D*/
 ...
 if (ThisTask == 0)
  {
   printf("COMOVING/SHELL_CODE adaptive softening: current scale factor = %g\n", pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT));
   fflush(stdout);
  }

 hsoft = All.SofteningHalo * pow(All.Time/All.TimeBegin, COMOVING_ADAPTIVE_SOFT);
#endif
