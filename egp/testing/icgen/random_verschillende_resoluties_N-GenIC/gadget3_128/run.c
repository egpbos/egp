...
void generate_permutation_in_active_list(void)
{
  ...
  first_list = (int *) mymalloc(maxseg * sizeof(int));
  last_list = (int *) mymalloc(maxseg * sizeof(int));
  ...
  permut = (struct permut_data *) mymalloc(nseg * sizeof(struct permut_data));
  ...
  if(ThisTask == 0)
    { 
      ...
      fprintf(FdCPU,
	      ...
	      + All.CPU_Sum[CPU_SMTHCOMM] + All.CPU_Sum[CPU_SMTHMISC],
	      (All.CPU_Sum[CPU_SMTHCOMPUTE] + All.CPU_Sum[CPU_SMTHWAIT]
	       + All.CPU_Sum[CPU_SMTHCOMM] + All.CPU_Sum[CPU_SMTHMISC]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_HOTNGBS], (All.CPU_Sum[CPU_HOTNGBS]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_WEIGHTS_HOT], (All.CPU_Sum[CPU_WEIGHTS_HOT]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_ENRICH_HOT], (All.CPU_Sum[CPU_ENRICH_HOT]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_WEIGHTS_COLD], (All.CPU_Sum[CPU_WEIGHTS_COLD]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_ENRICH_COLD], (All.CPU_Sum[CPU_ENRICH_COLD]) / All.CPU_Sum[CPU_ALL] * 100,
	      All.CPU_Sum[CPU_CSMISC], (All.CPU_Sum[CPU_CSMISC]) / All.CPU_Sum[CPU_ALL] * 100,
